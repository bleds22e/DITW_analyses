...
ggsave("../plots/Q15_means.png", height = 5, width = 5)
```
...
ggplot(Q15, aes(x = survey, y = prop, fill = response_word)) +
  ...
  theme(axis.title.y = element_blank(),
        axis.title = element_text(face = "bold", size = 20),
        axis.text = element_text(size = 14))
ggsave("../plots/Q15_stacked.png", width = 7, height = 7)
```
...
ggsave("../plots/Q17_1_means.png", height = 5, width = 5)
```
...
ggsave("../plots/Q17_1_stacked.png", width = 7, height = 7)
```
...
ggsave("../plots/Q17_2_means.png", height = 5, width = 5)
```
...
ggsave("../plots/Q17_2_stacked.png", width = 7, height = 7)
```
...
ggsave("../plots/Q17_3_means.png", height = 5, width = 5)
```
...
ggsave("../plots/Q17_3_stacked.png", width = 7, height = 7)
```
...
ggsave("../plots/Q17_4_means.png", height = 5, width = 5)
```
...
ggsave("../plots/Q17_4_stacked.png", width = 7, height = 7)
```
